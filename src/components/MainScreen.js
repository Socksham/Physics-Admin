...
const MainScreen = () => {
    ...
    async function getDays(daTopic, daClass){
        ...
        const ref = db.collection("class").doc(daClass).collection("topics").doc(daTopic).collection("days").orderBy('dayNum', 'asc')
        ...
        days.docs.forEach(async (doc, i) => {
            ...
            var homeworkBlah = await db.collection("class").doc(daClass).collection("topics").doc(daTopic).collection("days").doc(doc.id).collection("homework").get()

            var extrasBlah = await db.collection("class").doc(daClass).collection("topics").doc(daTopic).collection("days").doc(doc.id).collection("extras").get()
    ...
    return (
        <div className="">
            ...
            <div className="flex">
                ...
                <MainContent days={daysData} dayIds = {dayIds} gotData={gotData} homework={homework} extras={extras} className = {className} topicName={topicName} func={changeClass}/>
            </div>
